  ...
  module Stores
    module Postgres
      class WeightedSumQuery
        def initialize(store:, initial_value:)
          @store = store
        ...
        attr_reader :store, :initial_value

        delegate :from_datetime, :to_datetime, :events, :charges_duration, :sanitized_propery_name, to: :store
